...
public class NetflixTester {
	...
	public static final String baseFile = "testingDatasets" + FileIO.fileSeparator + "4Ratings.csv";
	public static final String testFile = "testingDatasets" + FileIO.fileSeparator + "4Tests.csv";
